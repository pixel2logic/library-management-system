    ...
    <div class="container">
        ...
        <main>
            <div class="form-container">
                ...
                <form:form action="${pageContext.request.contextPath}/books" method="post" modelAttribute="book" cssClass="form">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="isbn" id="isbn" cssClass="form-control" placeholder="Enter ISBN (e.g., 978-3-16-148410-0)" required="true"/>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="genre" id="genre" cssClass="form-control" placeholder="Enter genre (e.g., Fiction, Science)"/>
